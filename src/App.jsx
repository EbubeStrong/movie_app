  ...
  return (
    <div className={`app ${darkMode && "app-dark"}`}>
      <Routes>
        ...
        <Route
          element={<Series darkMode={darkMode} />}
          path="/movies/:series"
        />
        <Route
          element={<WatchScreen darkMode={darkMode} />}
          path="/watch/:id"
        />
        <Route
          element={<SearchScreen darkMode={darkMode} />}
          path="/search/:input"
        />
        <Route
          element={
...
//   // Listen to Supabase for user preference updates
//   useEffect(() => {
//     const subscription = supabase
//       .channel("users")
//       .on(
...
//         },
//         (payload) => {
//           if (payload.new.userid === userId?.id) {
//             setDarkMode(payload.new.darkmode);
//             setFavoriteMoviesId(payload.new.moviesid);
//           }
//         }
...
//         <Route element={<Home darkMode={darkMode} />} path="/" />
//         <Route element={<Movies darkMode={darkMode} />} path="/movies" />
//         <Route element={<Series darkMode={darkMode} />} path="/series/:id" />
//         <Route
//           element={<WatchScreen darkMode={darkMode} />}
//           path="/watch/:id"
//         />
